package com.trainingapplication.utils;
...
public class EmailSendUtils {
	...
	public void SendEmail(String to, String course) {
		...
		String schduleTime="6.00 Am to 8.00 Am";
		if(info.equalsIgnoreCase("evening"))
			schduleTime="6.00 Pm to 9.00Pm";
			
		   final String username ="conqueror768@gmail.com";
	       final String password = "zhyqgkyzruyxayhc"; //app code copy and past here
	        ...
	        try {
	            ...
	            message.setFrom(new InternetAddress("conqueror768@gmail.com"));
